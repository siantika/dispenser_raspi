...
class PrimaryFiniteStateMachine:
    def __init__(self):
        ...
        self.transitions = {
            ...
            (State.GENERATING_TICKET, Event.TICKET_GENERATED) : State.PRINTING_TICKET,
            (State.SENDING_DATA, Event.DATA_SENT) : State.GATE_OPEN,
            (State.PRINTING_TICKET, Event.PRINT_DONE) : State.SENDING_DATA,
